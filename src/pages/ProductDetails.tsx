    ...
    <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
        ...
        <motion.div
           ...
           className="space-y-4"
        >
          <div className="aspect-[3/4] bg-muted rounded-3xl overflow-hidden group relative">
            <img 
              src={product.image} 
              alt={product.name} 
          ...
          <div className="grid grid-cols-4 gap-4">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="aspect-square bg-muted rounded-2xl overflow-hidden cursor-pointer border-2 border-transparent hover:border-accent transition-all">
        ...
        >
          <div className="flex justify-between items-start mb-4">
            <div className="space-y-1">
              ...
              <h1 className="text-5xl font-bold tracking-tightest text-primary leading-tight">{product.name}</h1>
            </div>
            <button 
          ...
          <div className="flex items-baseline gap-4 mb-10">
            ...
            <span className="text-xs font-bold text-accent bg-accent/5 px-3 py-1 rounded-full uppercase tracking-widest">In Stock</span>
          </div>
          ...
          <div className="space-y-8 mt-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="flex-grow bg-primary text-white py-5 rounded-2xl font-bold uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-accent transition-all shadow-xl shadow-accent/10 active:scale-95"
              >
                <ShoppingBag className="w-5 h-5" />
                Add to Bag
              </button>
              <button 
                className="sm:w-20 bg-muted border border-transparent py-5 rounded-2xl flex items-center justify-center hover:border-gray-200 transition-all text-gray-500 hover:text-primary"
              >
            ...
            <div className="grid grid-cols-3 gap-4 pt-8 border-t border-gray-100">
               <div className="flex flex-col items-center gap-2 text-center">
                 <div className="w-10 h-10 bg-muted rounded-full flex items-center justify-center text-gray-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 py-20 border-t border-gray-100 mb-40">
        ...
        <div className="lg:col-span-8 bg-[#F8F8F8] p-16 flex flex-col justify-center space-y-10 border border-gray-100">
      ...
      <section className="space-y-20 border-t border-gray-100 pt-32">
        <div className="flex justify-between items-end">
          <div className="space-y-4">
             ...
             <h2 className="text-5xl font-black tracking-tighter uppercase text-primary">You May Also Seek</h2>
          </div>
